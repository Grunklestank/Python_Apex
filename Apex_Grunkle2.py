...
if __name__ == "__main__":
    ...
    p_paB_pass, paB_ev      = runPA("PA")
    p_paS_pass, paS_ev      = runPA_SMALL("PA_SMALL")



    p_eval_fail             = 1 - p_eval_pass
    p_paB_fail              = 1 - p_paB_pass
    p_paS_fail              = 1 - p_paS_pass
    c_eval_fail             = CONFIG["EVAL"]["cost_lose"]
    e_eval_fail             = p_eval_fail * c_eval_fail
    
    p_eval_pass_paB_fail     = p_eval_pass * p_paB_fail
    c_eval_pass_paB_fail     = CONFIG["EVAL"]["cost_win"] + CONFIG["PA"]["cost_lose"]
    e_eval_pass_paB_fail     = p_eval_pass_paB_fail * c_eval_pass_paB_fail
    
    p_eval_pass_paB_pass_paS_fail     = p_eval_pass * p_paB_pass * p_paS_fail
    c_eval_pass_paB_pass_paS_fail     = CONFIG["EVAL"]["cost_win"] + CONFIG["PA"]["cost_lose"]
    e_eval_pass_paB_pass_paS_fail     = p_eval_pass_paB_pass_paS_fail * c_eval_pass_paB_pass_paS_fail
    
    p_eval_pass_paB_pass_paS_pass     = p_eval_pass * p_paB_pass * p_paS_pass
    c_eval_pass_paB_pass_paS_pass     = CONFIG["EVAL"]["cost_win"] + CONFIG["PA_SMALL"]["cost_win"]
    e_eval_pass_paB_pass_paS_pass     = p_eval_pass_paB_pass_paS_pass * c_eval_pass_paB_pass_paS_pass

    p_total                 = p_eval_fail + p_eval_pass_paB_fail + p_eval_pass_paB_pass_paS_fail + p_eval_pass_paB_pass_paS_pass
    e_total                 = e_eval_fail + e_eval_pass_paB_fail + e_eval_pass_paB_pass_paS_fail + e_eval_pass_paB_pass_paS_pass
    ...
    print(f"{'eval pass, paB_fail:':30}{p_eval_pass_paB_fail:<10.2f}{c_eval_pass_paB_fail:<10.2f}{e_eval_pass_paB_fail:<10.2f}")
    print(f"{'eval pass, paB_pass, paS_fail:':30}{p_eval_pass_paB_pass_paS_fail:<10.2f}{c_eval_pass_paB_pass_paS_fail:<10.2f}{e_eval_pass_paB_pass_paS_fail:<10.2f}")
    print(f"{'eval pass, paB_pass, paS_pass':30}{p_eval_pass_paB_pass_paS_pass:<10.2f}{c_eval_pass_paB_pass_paS_pass:<10.2f}{e_eval_pass_paB_pass_paS_pass:<10.2f}")
